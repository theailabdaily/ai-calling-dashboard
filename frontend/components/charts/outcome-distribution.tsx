        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-xs uppercase tracking-wider text-surface-500 bg-surface-50/50">
              <th className="text-left px-3 md:px-5 py-2 font-medium">Outcome</th>
              <th className="text-right px-3 py-2 font-medium">#{unitLabel}</th>
              <th className="text-right px-3 md:px-5 py-2 font-medium w-[110px] md:w-[180px]">%{unitLabel}</th>
            </tr>
          </thead>
          <tbody>
            {rows.length === 0 && (
            ...
            {rows.map((r) => {
              ...
              return (
                <tr key={r.outcome} className="border-t border-surface-100">
                  <td className="px-3 md:px-5 py-2 text-brand-navy">{r.outcome}</td>
          ...
          {rows.length > 0 && (
            <tfoot>
              <tr className="border-t-2 border-surface-200 bg-surface-50/50">
                ...
                <td className="px-3 md:px-5 py-2 text-right text-xs text-surface-500">{rows.length} categories</td>
              </tr>
            </tfoot>
          )}
        </table>
