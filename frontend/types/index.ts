...
export type OverviewMetrics = {
  ...
  // UPSC-only priority tiers; null on other workspaces. Sums to unique_connected_leads.
  upsc_priority_tiers: { hot: number; hot_warm: number; cold_warm: number; no_intent: number } | null;
